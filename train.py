...
from utils.data_utils_wb import get_loader
...
parser.add_argument("--logdir", default='/rhea/scratch/brussel/vo/000/bvo00025/vsc10468/models/SWIN_UNETR/Training_paper')
parser.add_argument(
...
parser.add_argument("--sw_batch_size", default=12, type=int, help="number of sliding window batch size")
...
def main():
    ...
    wandb.init(project='Single_label_bone_segmentation')
...
def main_worker(gpu, args):
    ...
    if args.squared_dice:
        dice_loss = DiceCELoss(
            to_onehot_y=True, include_background=False, softmax=True, squared_pred=True, smooth_nr=args.smooth_nr, smooth_dr=args.smooth_dr
        )
    else:
